...
public class PropositionEventTypeTests {
    ...
    public void test_PropositionEventType_toString() {
        assertEquals(
                MessagingTestConstants.EventDataKeys.Messaging.IAMDetailsDataKeys.EventType.DISMISS,
                PropositionEventType.IN_APP_DISMISS.toString());
        assertEquals(
                MessagingTestConstants.EventDataKeys.Messaging.IAMDetailsDataKeys.EventType
                        .INTERACT,
                PropositionEventType.IN_APP_INTERACT.toString());
        assertEquals(
                MessagingTestConstants.EventDataKeys.Messaging.IAMDetailsDataKeys.EventType.TRIGGER,
                PropositionEventType.IN_APP_TRIGGER.toString());
        assertEquals(
                MessagingTestConstants.EventDataKeys.Messaging.IAMDetailsDataKeys.EventType.DISPLAY,
