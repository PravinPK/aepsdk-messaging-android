...
public class MessagingUtilsTests {
    ...
    public void setup() {
        ...
        final Map<String, Object> propositionItemMap =
                MessagingTestUtils.getMapFromFile("propositionItemFeed.json");
        ...
        Map<String, Object> propositionItemMap2 =
                MessagingTestUtils.getMapFromFile("propositionItemFeed2.json");
    ...
    public void test_updatePropositionMapForSurface_PropositionsListToAddIsNull() {
        ...
        Assert.assertEquals(
                ...
                MessagingUtils.updatePropositionMapForSurface(
                        mockSurface, (List<Proposition>) null, mockMapToUpdate));
    }
    ...
    public void test_updatePropositionMapForSurface_MapToUpdateIsNull() {
        ...
        Assert.assertNull(
                MessagingUtils.updatePropositionMapForSurface(
                        mockSurface, mockPropositionsToAdd, null));
    }

    @Test
    public void test_updatePropositionMapForSurface_ValidPropositionList() {
        // test
        Map<Surface, List<Proposition>> updatedMap =
                MessagingUtils.updatePropositionMapForSurface(
                        mockSurface, mockPropositionsToAdd, mockMapToUpdate);
    ...
    public void test_updatePropositionMapForSurface_SurfaceDoesNotExist_WithValidPropositionList() {
        ...
        Map<Surface, List<Proposition>> updatedMap =
                MessagingUtils.updatePropositionMapForSurface(
                        mockSurface2, mockPropositionsToAdd, mockMapToUpdate);
    ...
    public void test_updatePropositionMapForSurface_PropositionToAddIsNull() {
        ...
        Assert.assertEquals(
                mockMapToUpdate,
                MessagingUtils.updatePropositionMapForSurface(
                        mockSurface, (Proposition) null, mockMapToUpdate));
    }
    ...
    public void test_updatePropositionMapForSurface_MapToUpdateIsNullWithValidProposition() {
        ...
        Assert.assertNull(
                MessagingUtils.updatePropositionMapForSurface(
                        mockSurface, mockPropositionToAdd1, null));
    }
    ...
    public void test_updatePropositionMapForSurface_ValidProposition() {
        ...
        Map<Surface, List<Proposition>> updatedMap =
                MessagingUtils.updatePropositionMapForSurface(
                        mockSurface, mockPropositionToAdd1, mockMapToUpdate);
    ...
    public void test_updatePropositionMapForSurface_SurfaceDoesNotExist_WithValidProposition() {
        ...
        Map<Surface, List<Proposition>> updatedMap =
                MessagingUtils.updatePropositionMapForSurface(
                        mockSurface2, mockPropositionToAdd1, mockMapToUpdate);
