...
public class ImageAssetCachingTests {
    ...
    private static final String IMAGE_URL = "https://www.adobe.com/adobe.png";
    private static final String IMAGE_URL2 = "https://www.adobe.com/adobe2.png";
    ...
    public void testCacheImageAssets_ValidImageAssetListTriggersRemoteAssetFetch() {
        ...
        setupServiceProviderMockAndRunTest(
                () -> {
                    ArgumentCaptor<NetworkRequest> networkRequestArgumentCaptor =
                    ...
                    verify(mockNetworkService, times(2))
                            .connectAsync(
                                    networkRequestArgumentCaptor.capture(),
                                    any(NetworkCallback.class));
                    List<NetworkRequest> networkRequestList =
                            networkRequestArgumentCaptor.getAllValues();
    ...
    public void testCacheImageAssets_MissingAssetCacheDirectory_Then_AssetsNotCached() {
        ...
        setupServiceProviderMockAndRunTest(
                () -> {
                    ...
                    verify(mockNetworkService, times(0))
