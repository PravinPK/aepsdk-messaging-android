...
class PropositionPayload implements Serializable {
    ...
    private PropositionPayload(
            final PropositionInfo propositionInfo, final List<Map<String, Object>> items) {
        ...
        for (final Map<String, Object> item : items) {
            try {
                ...
                Log.debug(
                        ...
                        SELF_TAG,
                        "Unable to create a PayloadItem, an exception occurred: %s.",
                        exception.getLocalizedMessage());
            }
        }
    }

    static PropositionPayload create(
            final PropositionInfo propositionInfo, final List<Map<String, Object>> items) {
